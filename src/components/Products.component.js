...
class Products extends Component {
  UNSAFE_componentWillMount() {
    // uncomment this if your fetchProducts is HOC
...
// mapStateToProps: equivalent this.state={ } for our this component.
...
const mapStateToProps = (state) => ({
  // one liner: mapStateToProps is way of getting redux store state in react component as props.
...
// Note: suppose needdyComponent doesn't need props only want to import some dispatched function then we can write
